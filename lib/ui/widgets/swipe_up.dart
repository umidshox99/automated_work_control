      ...
      body: GestureDetector(
        ...
        onVerticalDragUpdate: (details) {
          if (details.globalPosition.dy - _initialOffset < 0.0) {
            this.setState(() {
              _swipeOffset = -(details.globalPosition.dy - _initialOffset) * widget.sensitivity;
            });
          }
        },
        onVerticalDragEnd: (details) {
          if (_swipeOffset > MediaQuery.of(context).size.height / 25) {
            widget.onSwipe();
          }
          this.setState(() {
            _swipeOffset = 0.0;
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: <Widget>[
                  widget.showArrow ? Icon(Icons.keyboard_arrow_up, color: widget.color) : Container(),
                  Padding(
